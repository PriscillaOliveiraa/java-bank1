...
import br.com.dio.model.repository.AccountRepository;
import br.com.dio.model.repository.InvestmentRepository;
...
public class Main {
    ...
    public static void main(String[] args) {
        System.out.println("Olá sejá bem vindo ao DIO Bank");
        while (true){
            System.out.println("Selecione a operação desejada");
            System.out.println("1 - Criar conta");
            System.out.println("2 - Realizar um investimento");
            System.out.println("3 - Criar um investimento");
            System.out.println("4 - Depositar na conta");
            System.out.println("5 - Sacar da conta");
            System.out.println("6 - Transferência entre contas");
            System.out.println("7 - Investir");
            System.out.println("8 - Sacar investimento");
            System.out.println("9 - Listar contar");
            ...
            switch (option){
                ...
                case 3-> createWalletInvest();
                case 4-> deposit();
                case 5-> withdraw();
                case 6-> transferToAcconut();
                case 7-> incInvestement();
    ...
    private static void createAccount(){
        ...
        System.out.println("Por favor informe o valor inicial de depósito:");
    ...
    private static void createInvestment(){
        System.out.println("Infome a taxa do investmento");
    ...
    private static void deposit(){
        System.out.println("Informe a chaeve pix da conta para deposito:");
        var pix  = scanner.next();
    ...
    private static void transferToAcconut(){
        System.out.println("Informe a chaeve pix da conta de origem:");
        var source  = scanner.next();
        System.out.println("Informe a chaeve pix da conta de destino:");
    ...
    private static void createWalletInvest(){
        System.out.println("Informe a chaeve pix da conta:");
        var pix  = scanner.next();
    ...
    private static void incInvestement(){
        System.out.println("Informe a chaeve pix da conta para investimento:");
        var pix  = scanner.next();
